...
% an extension of th one provided by [capt-of](https://www.ctan.org/pkg/capt-of).
% Includes the [newfloat package](https://www.ctan.org/pkg/newfloat), which minted is set
% up to use.
