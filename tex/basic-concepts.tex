...
% TODO: talk about how the term cache line is commonly conflated to mean an appropriately
% sized and *aligned* block of main memory that can be loaded into a cache line.  This is
% how it works, right?  Or can we load blocks starting at arbitrary addresses into a cache
% line?  Or maybe we can take memory that isn't even contiguous?
%
% Maybe talk about the 64-bit bus width and burst mode as well.  And maybe about how a
% write requires a read if we only write part of a cache line and the optimization of
